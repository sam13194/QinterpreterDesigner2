...
import type { VisualCircuit } from './circuit-types';

export interface LibraryCircuitInfo {
  id: string;
  name: string;
  description: string;
  // visualCircuit?: VisualCircuit; // Actual circuit data can be added later
}
...
export const PREDEFINED_CIRCUITS: LibraryCategory[] = [
  ...
  },
  {
    ...
    circuits: [
      ...
      { id: 'grover_2', name: "Grover's Search (2 Qubits)", description: "Demonstrates Grover's algorithm for 2 qubits." },
      { id: 'grover_3', name: "Grover's Search (3 Qubits)", description: "Demonstrates Grover's algorithm for 3 qubits." },
      { id: 'grover_4', name: "Grover's Search (4 Qubits)", description: "Demonstrates Grover's algorithm for 4 qubits." },
  ...
  // Custom Gates category will be handled dynamically in the future
  // {
  //   id: 'custom_gates',
  //   name: 'Custom Gates',
  //   circuits: [], // User-defined circuits will go here
  // },
];
